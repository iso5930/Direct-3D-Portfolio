...
Engine::CLight* Engine::CLight::Create(LPDIRECT3DDEVICE9 pDevice, const D3DLIGHT9* pLightInfo, const WORD& wLightIdx)
{
...
const D3DLIGHT9* Engine::CLight::GetLightInfo(void)
{
	return &m_LightInfo;
}