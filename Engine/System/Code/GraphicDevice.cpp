...
HRESULT Engine::CGraphicDevice::InitGraphicDev(WINMODE Mode, HWND hWnd, const WORD& wSizeX, const WORD& wSizeY)
{
...
void Engine::CGraphicDevice::SetParameters(D3DPRESENT_PARAMETERS& d3dpp, WINMODE Mode, HWND hWnd, const WORD& wSizeX, const WORD& wSizeY)
{
...
LPDIRECT3DDEVICE9 Engine::CGraphicDevice::GetDevice(void)
{
	return m_pDevice;
}