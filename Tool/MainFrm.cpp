...
BOOL CMainFrame::OnCreateClient(LPCREATESTRUCT lpcs, CCreateContext* pContext)
{
	...
	m_MainSplitter.CreateView(0, 0, RUNTIME_CLASS(CSheetView), CSize(350, WINCY), pContext);
			
	m_pMainView = (CToolView*)m_MainSplitter.GetPane(0, 1);
	m_pSheetView = (CSheetView*)m_MainSplitter.GetPane(0, 0);

	SetActiveView((CView*)m_MainSplitter.GetPane(0, 0));
